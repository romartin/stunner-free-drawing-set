...
@ApplicationScoped
public class FreeDrawingPaletteViewFactory extends BindableBS3PaletteGlyphViewFactory {
    ...
    protected FreeDrawingPaletteViewFactory() {
        this(null);
    }

    @Inject
    public FreeDrawingPaletteViewFactory(final ShapeManager shapeManager) {
        super(shapeManager);
    }
