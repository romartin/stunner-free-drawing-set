...
2.- Create a new Run/Debug configuration as:                
  ...
  - *GWT Modules to load*: org.kie.workbench.common.stunner.freedraw.FastCompiledStunnerFreeDrawingShowcase
  - *VM options*: 
...
- `org.kie.workbench.common.stunner.freedraw.demo.url` - URL for the git repository.
- `org.kie.workbench.common.stunner.freedraw.demo.username` - The git repository username.
- `org.kie.workbench.common.stunner.freedraw.demo.password` - The git repository password.
